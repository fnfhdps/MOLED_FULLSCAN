...
// 	typedef std::basic_stringstream<TCHAR>	tstringstream;
	...
	template <typename T>
	class AFX_EXT_CLASS Point : public Shape<T>
	{
	public:
		T x;
		T y;
		...
		{
			double rad = TheMath::deg2rad(deg);
			return Point<T>((T)(from.x + length * cos(rad)), (T)(from.y + length * sin(rad)));
		}
	...
	template <typename T>
	class AFX_EXT_CLASS Line : public /*virtual*/ Shape<T>
	{
	public:
		Point<T> P1;
		Point<T> P2;
